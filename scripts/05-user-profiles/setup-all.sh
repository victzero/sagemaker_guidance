#!/bin/bash
# =============================================================================
# setup-all.sh - User Profiles 主控脚本
# =============================================================================
# 使用方法: ./setup-all.sh
# =============================================================================
...
echo ""
echo -e "${CYAN}=============================================="
echo -e " User Profiles Setup - Master Script"
echo -e "==============================================${NC}"
echo ""
...
# 确认执行
echo -e "${YELLOW}This script will create User Profiles in SageMaker Domain:${NC}"
echo ""
    ...
    for project in $projects; do
        ...
        if [[ -n "$users" ]]; then
            ...
            for user in $users; do
                ...
                echo "    - $profile_name (IAM: $iam_user)"
                ((profile_count++)) || true
            done
        fi
    done
...
echo ""
echo "  Total: $profile_count user profiles"
echo ""

# ========== Summary ==========
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}Summary: $profile_count User Profiles to create${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
echo ""
echo -e "${GREEN}=============================================="
echo -e " User Profiles Setup Complete!"
echo -e "==============================================${NC}"
echo ""
