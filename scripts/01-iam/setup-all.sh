...
echo ""
echo -e "${YELLOW}Note: Execution Roles use default path (/) for SageMaker compatibility.${NC}"
echo ""
...
echo "  aws iam list-roles --query 'Roles[?starts_with(RoleName, \`SageMaker-\`)].RoleName'"
echo ""
echo "Note: Execution Roles use default path (/) for SageMaker service compatibility."
echo ""
echo "Next Steps:"
...
echo "  4. Users can now login to Studio and use Private Space"
